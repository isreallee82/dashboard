...
initialize_st_page(title="Simple PMM", icon="👨‍🏫")
backend_api_client = get_backend_api_client()

# Page content
st.text("This tool will let you create a config for Simple pmm, backtest and upload it to the Backend API.")
get_default_config_loader("simple_pmm")
